...
spark2-submit --master local[2] --class example.Hello --packages org.apache.hbase:hbase-common:1.2.0,org.apache.spark:spark-streaming-flume_2.11:2.2.0,org.apache.hbase:hbase-client:1.2.0,org.apache.spark:spark-sql_2.12:2.2.0,org.apache.spark:spark-mllib_2.12:2.2.0,org.mongodb.spark:mongo-spark-connector_2.11:2.4.0 --name target/scala-2.11/xratestreaming\_2.11-0.1.0-SNAPSHOT.jar
